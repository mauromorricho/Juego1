...
# Creamos la nave
nave = pygame.image.load("navecita.png")
naverect = nave.get_rect()
naverect.move_ip(490,225)

explosion = pygame.image.load("explosionGif.gif")
...
# Collide de la nave
    if naverect.colliderect(ballrect):
        # nave = False
        ventana.blit('explosionGif.gif',(ballrect.x, ballrect.y))
